...
<div class="container" style="padding-left:180px;">
 ...
 if ($result){
     while($row=mysqli_fetch_assoc($result)){
        ...
        <th scope="row">.<a href="ViewMedirecord.php?clickid='.$id.'" class="text-dark">'.$id.'</th>
        <td>'.$name.'</td>
        <td>'.$quantity.'</td>
        <td>'.$manufacture.'</td>
        <td>'.$expiry.'</td>
        ...
        <button class="btn btn-danger"><a href="Delete_medicine.php? deleteid='.$id.'" class="text-light">Delete</a></button>
        </td> 
        </tr>';
     }
 }
